package ru.otus.java.pro.transferservice.controllers;

import lombok.RequiredArgsConstructor;
import org.springframework.web.bind.annotation.*;
import ru.otus.java.pro.transferservice.dtos.ExecuteTransferDtoRq;
import ru.otus.java.pro.transferservice.dtos.TransferDto;
import ru.otus.java.pro.transferservice.dtos.TransfersPageDto;
import ru.otus.java.pro.transferservice.entities.Transfer;
import ru.otus.java.pro.transferservice.exceptions_handling.ResourceNotFoundException;
import ru.otus.java.pro.transferservice.services.TransfersService;
